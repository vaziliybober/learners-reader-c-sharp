...
namespace Learners_Reader.Epub
{
    public class Book
    {
        ...
        private void LoadBook()
        {
            ...
            this.ChapterTitles = parser.ChapterTitles;
        }

        private string InjectJavascriptIntoChapter(string section)
        {
            string hammer = @"<script>/*! Hammer.JS - v2.0.8 - 2016-04-23
...
function getWordClicked(e) {
  ...
  hammertime.on('doubletap', getWordClicked);
  ...
  hammertime.on('swipedown', function (e) {
    alert('swipe down');
            ...
            return section.Replace("</body>", hammer + js + "</body>");
        }
